...
<link rel="stylesheet" href="css/presenza.css">



    <link rel="stylesheet" href="css/nozze.css">
           ...
           <div class="container">
              ...
              <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                 <ul class="navbar-nav">
                    ...
                    <li><a class="nav-link" href="presenza.html">LISTA DEGLI INVITATI</a></li>
                   ...
                   <form id="contactForm">
                     <div class="row">
                       ...
                       <div class="col-md-12">
                        ...
                        <div class="form-group" required data-error="Dichiara la tua intenzione di partecipare">
                            <select class="custom-select d-block form-control" id="event"  placeholder="Your Email" id="email" class="form-control" name="name" required data-error="Please enter your email">
                              <option required data-error="Dichiara la tua intenzione di partecipare">Dichiara la tua intenzione di partecipare</option>
                              <option value="1">Parteciperò</option>
                              <option value="2">Non parteciperò</option>
                              <option value="3">Non lo so ancora</option>
                            </select>
                            <div class="help-block with-errors"></div>
                       ...
                       <div class="col-md-12">
                           <div class="form-group">
                               <select class="custom-select d-block form-control" id="guest" required data-error="Please enter your name">
...
document.getelementbyId(name).inner.HTML= "conferma tutti i campi";
    </script>
...
<script src="js2/presenza.js"></script>
</html>